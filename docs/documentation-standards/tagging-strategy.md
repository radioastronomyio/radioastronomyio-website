...
description: "Controlled vocabulary for document classification in radioastronomyio-website"
...
Controlled tag vocabulary for the radioastronomyio-website repository. Consistent tagging enables human navigation and RAG system retrieval.
...
|-----|---------|----------|
| `website` | Site pages, layout, navigation, routing, SEO, sitemap | The deployed site content and structure |
| `design` | Visual identity, color palette, typography, CSS architecture, graphics | How the site looks, not what it says |
| `content` | Page copy, research descriptions, project summaries | What the site communicates |
| `deployment` | Azure SWA config, GitHub Actions, CI/CD, custom domain, DNS | Getting the site live and keeping it running |
| `methodology` | Spec-driven development process, Nano Banana workflow, AI agent usage | How the site was built, the reproducible pattern |
...
| `guide` | Step-by-step procedures (Azure SWA setup, domain config) |
| `reference` | Website specification, style guide, design tokens |
| `specification` | The website-reference.md spec document |
